...
> เอกสารนี้สามารถใช้เป็นคู่มือเรียน Git เบื้องต้นถึงระดับใช้งานจริงได้ทันที  
> และสามารถนำไปอัปขึ้น GitHub เป็นไฟล์ `README.md` หรือ `git-guide.md` ได้เลย
